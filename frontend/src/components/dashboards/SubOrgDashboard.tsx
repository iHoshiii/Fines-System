...
export default function SubOrgDashboard() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            // Note: In the future, you can filter this to only show fines specific to this Sub Org
        ...
        <div>
            ...
            <div className="page-header">
                <div className="page-header-left">
                    <h2>{greetingTime()}, {profile?.full_name?.split(' ')[0] || 'Sub-Org Member'} 👋</h2>
                    <p>Welcome to the Sub-Organization Dashboard. Track student fines easily.</p>
                </div>
            </div>
