        ...
        <div>
            <div className="page-header">
                <div className="page-header-left">
                    ...
                    <p>Welcome to the Sub-Organization Dashboard. Manage your student fine records here.</p>
                </div>
            </div>
            ...
            <div className="table-container" style={{ marginTop: 24 }}>
                <div className="table-header">
                    ...
                    <span className="text-sm text-muted">Total sum per student (Your Organization)</span>
                </div>
                        ...
                        <div className="modal-body">
                            <div className="form-group"><label className="form-label">Description</label>
                                <select className="form-control" value={fineDescription} onChange={e => {
                                    ...
                                    if (e.target.value && typeof window !== 'undefined') window.localStorage.setItem(LAST_DESCRIPTION_STORAGE_KEY, e.target.value);
                                }}>
